data = readmatrix('data_motor.csv');
tiempo = data(:,1);
vel = data(:,2); % pulsos por segundo ( 3900 pps = 1 rps = ) 
pwm = data(:,3); % PMW en %
...
xlabel('Tiempo (s)');
ylabel('Salida');
title('Respuesta al Escalón Sistema de Primer Orden');
...
xlabel('Tiempo (s)');
ylabel('Salida');
title('Respuesta al Escalón Sistema de Segundo Orden');
legend('Salida', 'Valor final K');
